...
<Navbar class="desktop-navbar fixed start-0 top-0 z-20 w-full border-b px-2 py-2 sm:px-4">
	<NavBrand href="/">
	...
	<NavUl>
		{#each currentLinks as { icon, name, href }}
			<NavLi
				...
				class="mobile-nav-link relative mt-2 flex items-center px-4 py-2 font-semibold transition-colors duration-300 ease-in-out"
			>

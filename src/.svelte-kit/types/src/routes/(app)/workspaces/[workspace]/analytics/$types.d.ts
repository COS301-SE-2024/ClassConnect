...
type RouteId = '/(app)/workspaces/[workspace]/analytics';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../../src/routes/(app)/workspaces/[workspace]/analytics/+page.server.js').load>>>>>>;

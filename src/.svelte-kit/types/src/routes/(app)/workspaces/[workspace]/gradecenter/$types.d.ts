...
type RouteId = '/(app)/workspaces/[workspace]/gradecenter';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../../src/routes/(app)/workspaces/[workspace]/gradecenter/+page.server.js').load>>>>>>;

...
type RouteId = '/(app)/workspaces/[workspace]/dashboard';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../../src/routes/(app)/workspaces/[workspace]/dashboard/+page.server.js').load>>>>>>;

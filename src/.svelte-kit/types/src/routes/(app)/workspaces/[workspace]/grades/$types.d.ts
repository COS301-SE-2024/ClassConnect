...
type RouteId = '/(app)/workspaces/[workspace]/grades';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../../src/routes/(app)/workspaces/[workspace]/grades/+page.server.js').load>>>>>>;

...
<div class="relative h-full w-full overflow-hidden rounded-lg bg-gray-100 shadow-lg transition-all duration-300 hover:shadow-xl dark:bg-gray-800">
	{#if isVideoOff}
			<div class="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-gray-200 to-gray-300 dark:from-gray-700 dark:to-gray-800">
					<Avatar size="xl" src={participant.image} alt={participant.name} class="ring-4 ring-white dark:ring-gray-900" />
			</div>
	{:else}
			<video
	...
	<div class="absolute bottom-0 left-0 right-0 flex items-center justify-between bg-gradient-to-t  p-3">

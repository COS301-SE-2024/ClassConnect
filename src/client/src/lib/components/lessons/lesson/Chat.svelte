				...
				{#each messages as message (message.id)}
					<div class="mb-6 last:mb-0">
						<div class="flex items-start">
							...
							<div class="flex-grow p-3 bg-gray-200 dark:bg-gray-700 rounded-tr-lg rounded-br-lg rounded-bl-lg">
								<div class="flex items-center mb-2">
									<p class="text-sm font-semibold text-gray-900 dark:text-white">{message.user?.name}</p>

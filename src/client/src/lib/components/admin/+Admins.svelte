  ...
  <div class="sm:flex sm:items-center sm:justify-between">
      <div>
          <div class="flex items-center gap-x-3">
              ...
              <span class="px-3 py-1 text-xs text-green-600 bg-green-100 rounded-full dark:bg-gray-800 dark:text-green-400">{admins.length} {' '} lecturers</span>
          </div>
                  ...
                  <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                      ...
                      <tbody class="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                          ...
                          <tr>
                                  ...
                                  <div class="inline-flex items-center gap-x-3">
                                      <div class="flex items-center gap-x-2">
                                          ...
                                          <div>
                                              ...
                                              <p class="text-sm font-normal text-gray-600 dark:text-gray-400">{admin.adminID}</p>
                                          </div>
                                      </div>
                                  </div>
                              </td>
                              ...
                              <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">{admin.department}</td>
                              <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">{admin.email}</td>

<script lang="ts">
    ...
    const students = [
        ...
        },
        {
            ...
            email: 'bukhosi.mpande@demo.co.za',
        },
        {
            name: 'Ayanda Dlamini',
            studentID: 'u22231821',
        ...
        },
        {
            ...
            status: 'Active',
            studies: 'Undergraduate',
            email: 'ashley.kapaso@demo.co.za',
        },
        {
            name: 'Ayanda Juqu',
            studentID: 'e22242314',
...
<section class="container px-4 mx-auto my-2">
    <div class="flex items-center py-4 overflow-x-auto whitespace-nowrap">
        ...
        <a href="/students" class="text-green-600 dark:text-green-400 hover:underline">
            Students
        </a>
    </div>
    <div class="sm:flex sm:items-center sm:justify-between">
        <div>
            <div class="flex items-center gap-x-3">
                ...
                <span class="px-3 py-1 text-xs text-green-600 bg-green-100 rounded-full dark:bg-gray-800 dark:text-green-400">{students.length} {' '} lecturers</span>
            </div>
        ...
        <div class="flex items-center mt-4 gap-x-3">
            ...
            <button class="flex items-center justify-center w-1/2 px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 bg-green-500 rounded-lg shrink-0 sm:w-auto gap-x-2 hover:bg-blue-600 dark:hover:bg-blue-500 dark:bg-blue-600">
                            ...
                            <tr>
                                <td class="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                    <div class="inline-flex items-center gap-x-3">
                                        <div class="flex items-center gap-x-2">
                                            ...
                                            <div>
                                                <h2 class="font-medium text-gray-800 dark:text-white ">{student.name}</h2>
                                                <p class="text-sm font-normal text-gray-600 dark:text-gray-400">{student.studentID}</p>
                                            </div>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-12 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                    <div class="inline-flex items-center px-3 py-1 rounded-full gap-x-2 bg-emerald-100/60 dark:bg-gray-800">
                                        ...
                                        <h2 class="text-sm font-normal text-emerald-500">{student.status}</h2>
                                    </div>
                                </td>
                                <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">{student.studies}</td>

<script lang="ts">
	...
	import { Button, Modal, Label, Input, Fileupload, Radio ,Range} from 'flowbite-svelte';
	...
	<div class="flex flex-col space-y-4">
		<header class="flex items-center justify-between rounded-lg bg-gray-100 p-4 dark:bg-gray-700">
			...
			<div class="flex space-x-2">
				<Button on:click={() => (experimentModal = true)} color='blue' class="flex items-center  space-x-1">

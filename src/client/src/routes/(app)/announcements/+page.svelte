		...
		>
			...
			>
				...
				<p class="my-12 text-lg text-gray-500 md:text-xl lg:text-2xl">
					Great, looks like you have no announcements.
				</p>
				{#if data.role === 'admin'}
					<Button on:click={() => (isAddModalOpen = true)}>Create Announcement</Button>
				{/if}
			</div>
			<div class="flex w-1/2 justify-center lg:h-full lg:items-end">
				<svg
					...
					></ellipse><ellipse
						...
						ry="10.96996"
						fill="#3f3d56"
					></ellipse><circle cx="97.08375" cy="566.26982" r="79" fill="#2f2e41"></circle><rect
						x="99.80546"
						y="689.02332"
						width="24"
						height="43"
					...
					></ellipse><ellipse
						...
						fill="#2f2e41"
					></ellipse><circle cx="99.31925" cy="546.29477" r="27" fill="#fff"></circle><circle
						cx="99.31925"
						cy="546.29477"
						r="9"
						fill="#3f3d56"
					...
					></path><path
						...
						transform="translate(-39.70387 -61.04208)"
						fill="#3f3d56"
					></path><circle cx="712.48505" cy="565.41532" r="79" fill="#2f2e41"></circle><rect
						x="741.77716"
						y="691.82355"
						width="24"
						height="43"
					...
					></ellipse><ellipse
						...
						fill="#2f2e41"
					></ellipse><circle cx="708.52153" cy="545.71023" r="27" fill="#fff"></circle><circle
						cx="708.52153"
						cy="545.71023"
						r="9"
						fill="#3f3d56"
